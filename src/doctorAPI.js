class DoctorPull{
  getDoctor(nameQuery, conditionQuery) {
    return new Promise(function (resolve, reject) {
      ...
      nameQuery === '' ? url = `${frontAPI}?query=${conditionQuery}${backAPI}${process.env.exports.apiKey}` : url = `${frontAPI}?name=${nameQuery}&query=${conditionQuery}${backAPI}${process.env.exports.apiKey}`;
